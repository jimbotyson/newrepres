...
After this course participants will be able to identify the basic aims of reproducible research and demonstrate a working understanding of some of the associated tools.
...
Testing determined that there is no association between the two factors ($\chi^2$ = 20, df=2, p < .001)
